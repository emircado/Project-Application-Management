 ...
 * @property integer $uses_mobile_patterns
...
class Applications extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('project_id, type_id, uses_mobile_patterns', 'numerical', 'integerOnly'=>true),
            ...
            array('application_id, project_id, type_id, name, description, accessibility, repository_url, uses_mobile_patterns, instructions, rd_point_person, production_date, termination_date, date_created, date_updated, created_by, updated_by', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'uses_mobile_patterns' => 'Uses Mobile Patterns',
    ...
    public function search()
    {
        ...
        $criteria->compare('uses_mobile_patterns',$this->uses_mobile_patterns);
