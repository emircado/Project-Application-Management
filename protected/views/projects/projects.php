                                    ...
                                    <div id="edit-primary-content" class="content">
                                        ...
                                        <div class="field field-input-name">
                                            ...
                                            <div class="field-primary">
                                                ...
                                                <span id="edit-termination-error" class="field-input-name-error error-message" style="display: none;"></span>
                                                </div>
                                            </div><!-- End Field Primary -->
                                        </div><!-- End Field -->
                                ...
                                <div class="contact-info-details">
                                    ...
                                    <div id="create-primary-content" class="content">
                                        ...
                                        <div class="field field-input-name">
                                            ...
                                            <div class="field-primary">
                                                <div class="pseudo-field">
                                                <input type="date" id="create-termination" class="text"></input>
                                                <span id="create-termination-error" class="field-input-name-error error-message" style="display: none;"></span>
                                                </div>
                                            </div><!-- End Field Primary -->
                                        </div><!-- End Field -->
                                        <div class="dialog-footer-block">
