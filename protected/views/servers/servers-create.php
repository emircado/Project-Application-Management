...
<!-- create server view -->
<div id="servers-create" class="contact-info plain-list" style="display:none;">
    <!-- CONTENT HERE -->
    <form>
        ...
        <div class="contact-info-details">
            ...
            <div id="edit-primary-content" class="content">
                ...
                <div class="field field-input-name">
                    ...
                    <div class="field-primary">
                        <div class="pseudo-field">
                        <input id="servers-create-production" type="date" class="text"/>
                        </div>
                    </div><!-- End Field Primary -->
                </div><!-- End Field -->
                <div class="field field-input-name">
                    ...
                    <div class="field-primary">
                        <div class="pseudo-field">
                        <input id="servers-create-termination" type="date" class="text"/>
                        </div>
                    </div><!-- End Field Primary -->
                </div><!-- End Field -->
                    ...
                    <div class="field field-text">
                        <div class="field-action-content">
                            ...
                            <div class="pseudo-field pseudo-button primary-button">
                                <button id="servers-create-save-button">Save Changes</button>
                            </div>
