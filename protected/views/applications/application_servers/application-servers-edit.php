<!-- edit note view -->
<div id="edit-app-servers-view" class="contact-info plain-list" style="display:none;">
    <!-- CONTENT HERE -->
    <form>
            ...
            <div id="edit-primary-content" class="content">
                ...
                <div class="field field-input-name">
                    ...
                    <div class="field-primary">
                        <div class="pseudo-field no-border">
                            <span id="edit-app-servers-server" class="value"></span>
                        </div>
                ...
                <div class="field field-input-name">
                    ...
                    <div class="field-primary">
                        ...
                        <input id="edit-app-servers-path" type="text" class="text"/>
                        </div>
                    </div><!-- End Field Primary -->
                </div><!-- End Field -->
                <div class="field field-input-name">
                    ...
                    <div class="field-primary">
                        <div class="pseudo-field">
                        <input id="edit-app-servers-log" type="text" class="text"/>
                        </div>
                    </div><!-- End Field Primary -->
                </div><!-- End Field -->
                    ...
                    <div class="field field-text">
                        <div class="field-action-content">
                            <div class="pseudo-field pseudo-button">
                                <a id="edit-app-servers-cancel-button" class="cancel" href="#">Cancel</a>
                            </div>
                            <div class="pseudo-field pseudo-button primary-button">
                                <button id="edit-app-servers-save-button">Save Changes</button>
                            </div>
